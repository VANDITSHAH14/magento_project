...
class Ccc_Order_Adminhtml_OrderController extends Mage_Adminhtml_Controller_Action
{
    protected function _initAction()
    {
        ...
        $this->loadLayout()
            ->_setActiveMenu('system/order')
            ->_addBreadcrumb(Mage::helper('order')->__('Order'), Mage::helper('order')->__('Order'))
            ->_addBreadcrumb(Mage::helper('order')->__('Manage Order Status'), Mage::helper('order')->__('Manage Order Status'))
        ;
        return $this;
    }
    ...
    public function indexAction()
    {
        $this->_title($this->__('Order'))
             ->_title($this->__('Order Status Summary'))
             ->_title($this->__('Manage Order Status'));
