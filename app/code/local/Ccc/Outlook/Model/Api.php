...
class Ccc_Outlook_Model_Api extends Mage_Core_Model_Abstract
{
    ...
    public function getAccessToken($configModel)
    {
        ...
        $data = [
            ...
            'code' => $code,
            // 'redirect_uri' => $this->_redirectUri,
            'redirect_uri' => 'http://localhost/1SBMAGENTO/index.php/outlook/email/index',
    ...
    public function getEmails()
    {
        ...
        if (!is_null($readDateTime)) {
            ...
            // If readDateTime is null, order by receivedDateTime in ascending order
        ...
        $allEmails = $this->bodyContentOfEmails($emails['value']);

        return $allEmails;
    }

    public function bodyContentOfEmails($emails)
    {
        $refinedEmails = [];
